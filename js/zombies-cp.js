var helptext = "\
Welcome to Zombietown Capital Federal, a disease dynamics simulation of zombism across Capital Federal. \
...
ZombiesUI.prototype = {
    ...
    init: function(){
        loadGrid('dat/js-grid-cp.json', this.bind(function (dat) {
    ...
    draw_timing: function(sim){
        if (sim){
            ...
            this.ctx.fillText(txt, this.canvas.width - size - 30, 40);
